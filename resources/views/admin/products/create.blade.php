...
<div class="max-w-4xl mx-auto px-4 pb-10">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-white text-2xl font-bold tracking-tight">Tambah Produk Baru</h2>
                <p class="text-gray-400 text-xs uppercase tracking-widest mt-1">Input Stok Terbaru Serbu Comp</p>
            </div>
        </div>
    </div>

    <div class="bg-white/5 backdrop-blur-md rounded-[28px] border border-white/10 p-6 md:p-8 shadow-2xl">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" value="{{ old('price') }}" 
                               class="w-full bg-[#090069]/40 border border-white/10 rounded-2xl pl-12 pr-5 py-3.5 text-base text-white focus:outline-none focus:border-[#F0B22B]" 
                               placeholder="0" required>
                    </div>
                </div>
                <div class="space-y-2">
                    <label class="text-[#F0B22B] text-xs font-bold uppercase tracking-wider ml-1">Stok Awal</label>
            ...
            <div class="space-y-2">
                ...
                <textarea name="specs" rows="3" class="w-full bg-[#090069]/40 border border-white/10 rounded-2xl px-5 py-3.5 text-base text-white focus:outline-none focus:border-[#F0B22B]" placeholder="Tuliskan spek core produk..."></textarea>
            </div>

            <div class="space-y-2">
                <label class="text-[#F0B22B] text-xs font-bold uppercase tracking-wider ml-1">Detail Lengkap Produk</label>
                <textarea name="details" rows="4" class="w-full bg-[#090069]/40 border border-white/10 rounded-2xl px-5 py-3.5 text-base text-white focus:outline-none focus:border-[#F0B22B]" placeholder="Deskripsikan produk secara detail..."></textarea>
            </div>

            <div class="space-y-2">
                <label class="text-[#F0B22B] text-xs font-bold uppercase tracking-wider ml-1">Panduan Pembelian (Opsional)</label>
                <textarea name="purchase_guide" rows="3" class="w-full bg-[#090069]/40 border border-white/10 rounded-2xl px-5 py-3.5 text-base text-white focus:outline-none focus:border-[#F0B22B]" placeholder="Informasi cara order atau garansi..."></textarea>
            </div>

            <div class="p-6 bg-white/5 rounded-3xl border border-dashed border-white/20">
                <div class="flex flex-col sm:flex-row items-center gap-6">
                    <div class="w-20 h-20 bg-[#F0B22B]/10 rounded-2xl flex items-center justify-center text-[#F0B22B] shrink-0 border border-[#F0B22B]/20">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        <p class="text-white font-bold mb-2">Unggah Foto Produk</p>
                        ...
                        <p class="text-[10px] text-gray-500 mt-2 uppercase tracking-tighter">*Rekomendasi ukuran 1:1 atau 1080x1080px</p>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-4 flex justify-end">
                <button type="submit" 
                        class="w-full sm:w-auto px-12 py-3.5 bg-[#F0B22B] text-[#090069] rounded-2xl font-extrabold text-base uppercase tracking-wider hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-[#F0B22B]/20">
                    Publish Produk
                </button>
            </div>
        </form>
