...
<div class="flex flex-col gap-8 px-4 md:px-0">
    ...
    <div class="text-center md:text-left">
        <h2 class="text-white text-3xl font-bold">Product List</h2>
        <p class="text-gray-400 text-sm mt-1">
            Total <span class="text-[#F0B22B] font-bold">{{ $products->total() }}</span> produk tersedia.
        </p>
    </div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <form method="GET" action="{{ route('admin.products.index') }}">
                <div class="relative">
                    ...
                    <input 
                        ...
                        class="w-full pl-11 pr-4 py-3 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-gray-500
                               focus:outline-none focus:ring-2 focus:ring-[#F0B22B] transition-all"
                    >
                </div>
            </form>
        </div>
        ...
        <a href="{{ route('admin.products.create') }}" 
           class="flex items-center justify-center gap-2 bg-[#F0B22B] text-[#090069] font-bold px-8 py-3 rounded-2xl
