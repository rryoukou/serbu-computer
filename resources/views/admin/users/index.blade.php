...
<div class="w-full px-4 md:px-0 pb-12">
    ...
    <div class="reveal-anim mb-8 flex flex-col md:flex-row items-center justify-between gap-4 bg-white/5 p-4 rounded-2xl border border-white/10 backdrop-blur-md shadow-xl" style="animation-delay: 0.2s">
        ...
        <div class="flex items-center gap-3 bg-[#F0B22B]/10 px-5 py-2.5 rounded-2xl border border-[#F0B22B]/20 w-full md:w-auto justify-center group/total">
            ...
            <div class="text-left">
                ...
                <p class="text-white text-lg font-black leading-none mt-1 group-hover/total:scale-110 transition-transform">{{ $users->total() }}</p>
            </div>
        </div>
    </div>

    {{-- TABLE CONTAINER DENGAN ANIMASI --}}
    <div class="reveal-anim bg-white/5 backdrop-blur-md rounded-[24px] md:rounded-[32px] border border-white/10 overflow-hidden shadow-2xl" style="animation-delay: 0.3s">
                        ...
                        <td class="px-0 md:px-6 py-2 md:py-5 border-none">
                            <div class="flex items-center gap-4">
                                <div class="relative shrink-0">
                                    ...
                                    @if($user->is_banned)
                                        <div class="absolute -top-1 -right-1 w-4 h-4 bg-red-500 border-2 border-[#090069] rounded-full shadow-lg shadow-red-500/50"></div>
                                    @endif
                                </div>
                                <div>
                                    <p class="text-white text-base font-bold leading-tight group-hover:text-[#F0B22B] transition-colors">{{ $user->nama }}</p>
...
<div id="userModal" class="fixed inset-0 z-[9999] hidden flex items-center justify-center p-4">
    <div class="absolute inset-0 bg-[#090069]/95 backdrop-blur-xl transition-opacity duration-300" onclick="closeModal()"></div>
    <div class="bg-[#161B33] border border-white/10 w-full max-w-xl rounded-[40px] p-6 md:p-10 relative z-10 shadow-[0_0_50px_rgba(0,0,0,0.5)] transform transition-all duration-300 scale-90 opacity-0" id="modalContent">
        <button onclick="closeModal()" class="absolute top-8 right-8 text-gray-500 hover:text-[#F0B22B] transition-all hover:rotate-90">
        ...
        <div class="flex flex-col items-center text-center">
            <div class="relative group">
                <div class="absolute -inset-1 bg-[#F0B22B] rounded-[36px] blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                <img id="modalFoto" src="" class="relative w-24 h-24 md:w-32 md:h-32 rounded-3xl border-4 border-[#F0B22B]/20 object-cover mb-4">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
                <div class="bg-white/5 p-4 rounded-2xl border border-white/5 text-left hover:border-[#F0B22B]/30 transition-colors">
            ...
            <div class="w-full mt-3 bg-white/5 p-4 rounded-2xl border border-white/5 text-left hover:border-[#F0B22B]/30 transition-colors">
